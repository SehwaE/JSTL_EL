...
<!-- 
	JSTL의 코드를 사용하기 위해서 필요한 설정값을 지정
	prefix="접두어" uri="주소"
 -->
...
<body>
	...
	<!-- 
		=> 변수를 생성X, 속성(Attribute)을 생성O(Scope에 저장되는 값)
	 -->
	<%-- 	결과 : <%=sum2 %> (x)--%>
	<%-- 	결과 : <%=num1 %> (x) --%>
	...
	<%
// 	c:set var="name" value="컴퓨터" scope="request" 와 동일
